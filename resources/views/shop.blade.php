            ...
            <div class="img-wrapper">
                ...
                <div class="cart-wrap">
                    <ul>
                        ...
                        <li>
                            <a href="javascript:void(0)"onclick="addProductTowishlist({{$product->id}},'{{$product->name}}',1,{{$product->regu}})" class="wishlist">
...
function filterProductsByCategory(brand){
   ...
   function addProductTowishlist(id,name,quantitiy,price) 
   {
    $.ajax({
        type:'POST',
