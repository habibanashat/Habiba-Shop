...
<body class="theme-color4 light ltr">
    ...
    <header class="header-style-2" id="home">
        <div class="main-header navbar-searchbar" style="background-image: url(back.jpg)">
                                ...
                                <div class="main-navbar">
                                    <div id="mainnav">
                                        ...
                                        <ul class="nav-menu">
                                            ...
                                            <li><a href="{{route('about.index')}}" class="nav-link menu-title">About Me</a></li>
                    ...
                    <div class="col-xl-3 col-lg-4 col-md-6">
                        <div class="footer-contact">
                            ...
                            <ul class="contact-lists" style="clear:both;">
                                ...
                                <li>
                                    <span><b>Address:</b><span class="font-light"> Egypt
                                            </span></span>
                                </li>
                                <li>
                                    <span><b>Email:</b><span class="font-light">habibanashat630@gmail.com</span></span>
                                </li>
                            </ul>
                        </div>
                    </div>
        ...
        <div class="sub-footer">
            <div class="container">
                <div class="row gy-3">
                    ...
                    <div class="col-md-6">
                        <p class="mb-0 font-dark">© 2024,Habiba Nashat.</p>
                    </div>
                </div>
            </div>
        </div>
